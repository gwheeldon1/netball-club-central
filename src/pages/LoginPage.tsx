...
const LoginPage = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center gradient-secondary px-4 py-8 sm:py-12">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                   ...
                   <Input id="email" type="email" placeholder="name@example.com" value={email} onChange={e => setEmail(e.target.value)} required className="pl-10 h-11 text-base border-2 focus:border-primary transition-colors" autoComplete="email" name="email" />
                </div>
              </div>
              <div className="space-y-2">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                   ...
                   <Input id="password" type="password" placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} required className="pl-10 h-11 text-base border-2 focus:border-primary transition-colors" autoComplete="current-password" name="password" />
                </div>
              </div>
            </CardContent>
